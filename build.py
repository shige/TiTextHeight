...
def compile_js(manifest,config):
	js_file = os.path.join(cwd,'assets','com.bakorer.titextheight.js')
	...
	f = os.path.join(cwd,'Classes','ComBakorerTitextheightModuleAssets.m')
	c = open(f).read()
...
ignoreFiles = ['.DS_Store','.gitignore','libTitanium.a','titanium.jar','README','com.bakorer.titextheight.js']
